...
describe('Testing the favorite restaurant feature', () => {
  ...
  describe('positive scenarios', () => {
    test('should render the favorite button if the restaurant is not already in favorites', async () => {
      setupMocks({ isFavorited: false, indexedDBService, detailPage, favoriteBtn, model, view });
      ...
      expect(favoriteBtn.getAttribute('aria-label')).toBe('Mark this restaurant as favorite');
    });
    ...
    test('should render the favorite button with the favorite state and proper attributes', () => {
      ...
      view.renderFavoriteButton(favoriteBtn, false);
      ...
      expect(domService.setAttribute).toHaveBeenCalledWith(favoriteBtn, 'aria-pressed', 'false');
  ...
  describe('negative scenarios', () => {
    test('should not render the unfavorite button if the restaurant is not already in favorites', async () => {
      ...
      expect(favoriteBtn.getAttribute('aria-pressed')).not.toBe('true');
      expect(favoriteBtn.getAttribute('aria-label')).not.toBe('Unfavorite this restaurant');
    });
