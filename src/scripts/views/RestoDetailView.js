...
export default class RestoDetailView extends RestoBaseView {
  ...
  renderFavoriteButton(favoriteBtn, favorited) {
    ...
    if (favorited) {
      domService.setAttribute(favoriteBtn, 'aria-pressed', 'true');
      domService.setAttribute(favoriteBtn, 'aria-label', 'Unfavorite this restaurant');
      ...
      domService.setAttribute(favoriteBtn, 'aria-pressed', 'false');
      domService.setAttribute(favoriteBtn, 'aria-label', 'Mark this restaurant as favorite');
